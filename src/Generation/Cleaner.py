...
# endregion --- Grammar Generation

# region --- Ornamentation Generation
...
SLURS_RE = re.compile('[()]')
# endregion --- Ornamentation Generation

# region --- Timing Generation
